### ------------------------------------------------------------------------------------------------------ ###
### ------ Tamanho amostral para o teste Z unilateral para comparar uma média com um valor esperado ------ ###
### ------------------------------------------------------------------------------------------------------ ###
...
### -------------------------------------- ###
print(result$n)
cat("A tamanho mínimo para manter o poder específicado do teste Z unilateral para uma amostra é:", ceiling(result$n), "amostras.")
cat("\n")
