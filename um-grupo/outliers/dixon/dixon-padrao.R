...
if (result$p.value < alpha){
  cat("Rejeita H₀  (existe um possível outlier no conjunto de dados, adotando ", 100*(1-alpha), "% de confiança)\n")
...
# https://www.rdocumentation.org/packages/outliers/versions/0.15/topics/dixon.test
